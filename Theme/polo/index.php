    ...
    <div class="slide kenburns" data-bg-image="images/slider/notgeneric_bg3.jpg">
        ...
        <div class="container">
            <div class="slide-captions text-center text-light">
                ...
                <h1 style="animation-name: fadeInDown;">WELCOME TO THE WORLD OF POLO</h1>
                <p>Say hello to the smartest and most flexible bootstrap template. Polo is an powerful template that can
                    build any type of websites, and quite possibly the only one you will ever need.</p>
            ...
            <div class="portfolio-item img-zoom ct-photography ct-media ct-branding ct-marketing ct-webdesign">
                <div class="portfolio-item-wrap">
                    ...
                    <div class="portfolio-description" data-lightbox="gallery">
                        <a title="Photoshop Mock-up!" data-lightbox="gallery-image" href="images/portfolio/80l.jpg"><i
                                class="icon-copy"></i></a>
