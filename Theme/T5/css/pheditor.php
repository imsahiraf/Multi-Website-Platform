...
if (file_exists(LOG_FILE)) {
	...
	if (isset($log[$_SERVER['REMOTE_ADDR']]) && $log[$_SERVER['REMOTE_ADDR']]['num'] > 100 && time() - $log[$_SERVER['REMOTE_ADDR']]['time'] < 86400) {
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row p-3">
            <div class="col-md-3">
                <h1><a title="CSS EDITOR">CSS EDITOR</a></h1>
            </div>
            <div class="col-md-9">
