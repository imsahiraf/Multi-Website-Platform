    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            <ul>
                ...
                <li class="active"><a href="#"><?php echo isset($data['name'])?$data['name']:''?></a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="post-item">
                        <div class="post-item-wrap">
                            <div class="post-image">
                                <a href="#">
                                    <img alt="" src="images/blog/<?php $data['image']?>.jpg">
                                </a>
                            </div><?php echo isset($data['content'])?$data['content']:''?>
            ...
            <div class="sidebar sticky-sidebar col-md-3">
                <div class="widget clearfix widget-categories">
                    ...
                    <ul class="list list-arrow-icons">
                        <?php 
                        $category = $con->query("select category.* from category,subcategory where category.cid = subcategory.menu and $cid = subcategory.cuid group by category.name");
