...
if((time() - $_SESSION['last_ative_time'])>1800){
    echo '<script>alert("Sorry Session Expired Login Again To Continue!");document.location="include/logout.php"</script>';
    die();
}
}
...
<head>
    <title><?php echo $_SESSION['ausername']; ?> - Fourty60</title>
    <meta charset="utf-8">
