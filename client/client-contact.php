                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $q1 = mysqli_query($con,"SELECT * FROM contacts where site=$uid");
                                                ...
                                                <tr id="name">
                                                    ...
                                                    <td>
                                                        <a  class="btn btn-round btn-info" href="contact.php?id=<?php echo $r1['id'];?>"><i class="fa fa-edit"></i> Edit</a>&nbsp;
                                                        <a  class="btn btn-round btn-danger" href="client-contact.php?id=<?php echo $r1['id'];?>" title="Delete" data-id="<?php echo $r1['id']; ?>"><i class="fa fa-trash"> </i>Delete</a>&nbsp;
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                                <?php } else{
                                                   echo '<script>alert("Please Add Contact Details");document.location="contact.php"</script>';
                                                   } ?>
                                            </tbody>
                                        </table>
                                    </div>
