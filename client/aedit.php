                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Edit Product</h5>
                                            <span>Note: Edit Everything Or Else You Will Loose Your Data.</span>
                                        </div>
                                        <div class="card-block">
                                            <form method="POST" enctype="multipart/form-data">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control form-control-round" name="name" placeholder="Enter Product Name" value="<?php echo isset($data['name'])?$data['name']:''?>" id="slug-source">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Permanent Link URL</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control form-control-round" name="slug" placeholder="Enter Permanent URL" value="<?php echo isset($data['slug'])?$data['slug']:''?>" id="slug-target">
                                                    </div>
                                                </div>       
                                                <button type="button" class="btn-round btn-primary" onClick="myFunction()">
                                                    Convert
                                                </button>&nbsp;&nbsp;<span>Change Product Name Then Click On Convert</span>
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-sm-10"><input type="text"
                                                            ...
                                                            placeholder="Enter Product Meta Keywords" value="<?php echo isset($data['keywords'])?$data['keywords']:''?>"></div>
                                                </div>           
                                                <div class="form-group row"><label
                                                        class="col-sm-2 col-form-label">Product Meta Description</label>
                                                    <div class="col-sm-10"><input type="text"
                                                            class="form-control form-control-round" name="description"
                                                            placeholder="Enter Product Meta Description" value="<?php echo isset($data['description'])?$data['description']:''?>"></div>
                                                </div>          
                                                <div class="form-group row"><label
                                                        class="col-sm-2 col-form-label">Material</label>
                                                    <div class="col-sm-10"><select name="cid"
                                                            class="form-control form-control-round">
                                                            <option value="<?php echo isset($data['cid'])?$data['cid']:''?>">--Select--</option><?php $category_list_array=array();
                                                ...
                                                <div class="form-group row"><label class="col-sm-2 col-form-label">Menu Settings</label>
                                                    <div class="col-sm-10"><select name="menu"
                                                            class="form-control form-control-round">
                                                            <option value="<?php echo isset($data['scid'])?$data['scid']:''?>">--Select--</option>
                                                               <?php $category_list_array=array();
                                                                $selectpck="SELECT * FROM `subcategory` where cuid=$uid and scid != $scid ";
                                                                $sql=mysqli_query($con, $selectpck);
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="file" class="form-control form-control-round" name="image1" id="catimg" value="<?php echo isset($data['image'])?$data['image']:''?>">
                                                    </div>
                                                </div>
...
if(isset($_POST['add'])){
       ...
       if ($uploadOk != 0) {
        ...
        $con->query("UPDATE subcategory SET `name`='$name' , `slug`='$slug',`keywords`='$keywords' ,`description`='$description',`cid`='$cid',`menu`='$menu',`image`='$filename',content='$content'  where `subcategory`.`scid` = '$scid'");
    echo '<script>alert(" Update Successfully!");document.location="products.php"</script>';
}
?>
