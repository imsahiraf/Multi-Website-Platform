  ...
  <body themebg-pattern="theme1">
    <section class="login-block">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                        <form method="post" class="md-float-material form-material" enctype="multipart/form-data">
 ...
 if(isset($_POST['login']))
{
    ...
    $query = $con->query("SELECT * from sadmin where user = '$user' AND password='$password' ");
    $count= mysqli_num_rows($query);
    if($count == 1)
    {
       $row= mysqli_fetch_assoc($query);
       $_SESSION['sadminloggedin']  = $row['id'];
       $_SESSION['sausername'] = $row['user'];
