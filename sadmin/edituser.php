                                        ...
                                        <div class="card-block">
                                            <form method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control form-control-round" name="name" placeholder="Enter Name" value="<?php echo isset($data['name'])?$data['name']:''?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
...
if(isset($_POST['add'])){
        ...
        $con->query("UPDATE user SET `name`='$name' , user='$user' , password='$password'  where `user`.`buid` = '$buid'");
        echo '<script>alert("User Edited Successful!");document.location="seo.php"</script>';
}
