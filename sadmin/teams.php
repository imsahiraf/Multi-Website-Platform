                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Developers Team</h5>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="#">Developers Team</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="page-body">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a class="btn btn-primary btn-round waves-effect waves-light" href="addteam.php">Add Developer</a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $i=0;
                                                    $q1 = mysqli_query($con,"SELECT * from admin");
                                                ...
                                                ?>
                                                    <tr id="name">
                                                        ...
                                                        <td>
                                                            <a class="btn btn-xs btn-info" href="editteam.php?id=<?php echo $r1['id'];?>"><i class="fa fa-edit"></i> Edit</a>&nbsp;
                                                            <a class="btn btn-xs btn-danger" href="deleteteam.php?id=<?php echo $r1['id'];?>" title="Delete" data-id="<?php echo $r1['id']; ?>"><i class="fa fa-trash"> </i>Delete</a>&nbsp;
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
