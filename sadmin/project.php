                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block ">
                                            <div class="row">
                                                ...
                                                $i=0;
                                                $zid = $_GET['id'];
                                                $q1 = mysqli_query($con,"SELECT * from zs_sliders_img where zid= $zid");
                                                while($r1 = mysqli_fetch_assoc($q1))
                                                {  $i++;
                                                ?>
                                                <div class="col-md-3 ">
                                                    <div class="card "><a href="slider-editor.php?id=<?php echo $r1['id'];?>">
                                                            <img class="card-img" style="height: 150px;" src="../img/slider/<?php echo $r1['image'];?>" alt="Card image">
...
if(isset($_POST['add'])){
        ...
        if($con->query("insert into zs_sliders_img(`name`,`image`,`zid`)values('".$name."','".$filename."','".$zid."')")){
