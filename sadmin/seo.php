                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="#">SEO User</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="page-body">
                            <div class="card">
                                <div class="card-header">
                                    <h5>SEO Users</h5>
                                    <a class="btn btn-primary btn-round waves-effect waves-light" href="addseo.php">Add User</a>
                                </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="name">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-xs btn-info" href="edituser.php?id=<?php echo $r1['buid'];?>"><i class="fa fa-edit"></i> Edit</a>&nbsp;
                                                        <a class="btn btn-xs btn-danger deleteproduct" href="deleteuser.php?id=<?php echo $r1['buid'];?>" title="Delete" data-id="<?php echo $r1['scid']; ?>"><i class="fa fa-trash"> </i>Delete</a>&nbsp;
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
